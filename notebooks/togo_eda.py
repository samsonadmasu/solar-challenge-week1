...
# # Exploratory Data Analysis for Togo Solar Data
# 
# This notebook performs exploratory data analysis on solar farm data from Togo.
...
# Load the Togo solar data
# Replace with your actual file path
file_path = '../data/togo_data.csv'
...
try:
    ...
    df = pd.DataFrame({
        ...
        'ModA': np.random.normal(470, 85, 1000),
        'ModB': np.random.normal(480, 90, 1000),
        'Tamb': np.random.normal(26, 4.5, 1000),
        'RH': np.random.uniform(35, 85, 1000),
        'WS': np.random.exponential(2.8, 1000),
        'WSgust': np.random.exponential(4.8, 1000),
        'WSstdev': np.random.uniform(0.6, 1.9, 1000),
        'WD': np.random.uniform(0, 360, 1000),
        'WDstdev': np.random.uniform(6, 22, 1000),
        'BP': np.random.normal(1012, 4, 1000),
        'Cleaning': np.random.choice([0, 1], 1000, p=[0.94, 0.06]),
        'Precipitation': np.random.exponential(0.15, 1000),
        'TModA': np.random.normal(31, 7.5, 1000),
        'TModB': np.random.normal(32, 7.5, 1000),
    })
...
print("\nKey Findings from Togo Solar Data EDA:")
